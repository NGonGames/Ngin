...
LDLIBSOPTIONS=-L../../lib/win/static -lmingw32 -lSDLmain -lSDL.dll -lSDL_image -lSDL_ttf -lboost_system-mgw46-1_52 -lboost_filesystem-mgw46-1_52
...
${OBJECTDIR}/_ext/1445274692/Player.o: ../../src/Player.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1445274692
	${RM} $@.d
	$(COMPILE.cc) -O2 -s -I../../include -static-libgcc -static-libstdc++ -std=c++0x -mwindows -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1445274692/Player.o ../../src/Player.cpp
...
${OBJECTDIR}/_ext/1445274692/KeyboardController.o: ../../src/KeyboardController.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1445274692
	${RM} $@.d
	$(COMPILE.cc) -O2 -s -I../../include -static-libgcc -static-libstdc++ -std=c++0x -mwindows -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1445274692/KeyboardController.o ../../src/KeyboardController.cpp
